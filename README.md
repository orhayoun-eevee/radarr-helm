...
This chart deploys Radarr using the shared dependency `lib-chart` (`0.0.15`).
...
- `tests/radarr_contract_test.yaml`
...
- Main container runs as UID/GID `1013/1011`
- Config PVC claim: `radarr-config` (RWO)
